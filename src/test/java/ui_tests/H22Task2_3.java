...
public class H22Task2_3 extends Task2 {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void searchByApple() {
        ...
        driver.findElement(By.cssSelector("label[for=Samsung]")).click();

        driver.findElement(By.cssSelector("input[name=searchline]")).sendKeys("Apple");
        assertTrue(driver.findElement(By.cssSelector("p.checkbox-filter__glyph")).isDisplayed());
        ...
        for (WebElement e : elementsList) {
            assertTrue(e.getText().contains("Apple"));
        }
    }
}
